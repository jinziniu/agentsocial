...
### 极端案例 - 完全不能沟通
- **User G**: 技术极客（技术狂热，代码导向）- dealbreakers: 商业、盈利、市场、投资
- **User H**: 纯商业投资人（纯商业，投资导向）- dealbreakers: 技术、代码、开源、学习
  - **预期结果**: 匹配分数极低，关系动量为 "cooling"

- **User K**: 慢节奏学习者（慢节奏，深度思考型，能量3）- dealbreakers: 快节奏、高强度、每天、创业
- **User L**: 快节奏创业者（快节奏，高效执行型，能量10）- dealbreakers: 慢节奏、学习、思考、偶尔
  - **预期结果**: 匹配分数极低，关系动量为 "cooling"

### 极端案例 - 天作之合
- **User I**: 技术创业者（技术导向，创业型）- dealbreakers: 纯商业、无技术背景
- **User J**: 技术投资人（技术投资，创业导向）- dealbreakers: 无技术、纯商业炒作
  - **预期结果**: 匹配分数很高，关系动量为 "warming"

- **User M**: 设计师（创意导向，设计型）- dealbreakers: 纯技术、无创意
- **User N**: 产品经理（产品导向，创意型）- dealbreakers: 纯技术、无设计感
  - **预期结果**: 匹配分数很高，关系动量为 "warming"
